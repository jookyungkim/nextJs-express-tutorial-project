  ...
  return produce(state, (draft) => {
    switch (action.type) {
      ...
      case LOAD_FOLLOWINGS_REQUEST:
        draft.load_followingLoading = true;
        draft.load_followingDone = false;
        draft.load_followingError = null;
        break;
      case LOAD_FOLLOWINGS_SUCCESS:
        draft.load_followingLoading = false;
        draft.load_followingDone = true;
